...
Para ello, se utilizan las siguientes diferencias centradas:
\begin{equation}
...
\end{equation}
\begin{equation}
\frac{\partial^{2} u}{\partial t^{2}} = \frac{u(r, t + \Delta t) - 2 u(r,t) + u(r,t - \Delta t)}{\Delta t^{2}} + O(\Delta t^{2})
\end{equation}
...
\begin{equation}
\frac{v_{k+1}^{m} - 2v_{k}^{m} + v_{k-1}^{m}}{\Delta r^{2}} + \frac{1}{\frac{1}{2}+k\Delta r} \frac{v_{k+1}^{m}-v_{k-1}^{m}}{2\Delta r} = \frac{1}{4K} \frac{v_{k}^{m+1} - 2v_{k}^{m} + v_{k}^{m-1}}{\Delta t^{2}}
\end{equation}
\begin{equation}
v_{k}^{m+1} = 2v_{k}^{m} - v_{k}^{m-1} + \frac{4K\Delta t^{2}}{\Delta r^{2}} (v_{k+1}^{m} - 2v_{k}^{m} + v_{k-1}^{m}) + \frac{4K\Delta t^{2}}{2\Delta r (\frac{1}{2}+k\Delta r)} (v_{k+1}^{m}-v_{k-1}^{m})
