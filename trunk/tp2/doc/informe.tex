...
construir un vector de valores $v^{f_k}$, en donde el componente $v^{f_k}_i$ de dicho vector corresponde al resultado de la siguiente ecuación:
\begin{equation}
...
cierto paso entre instantes dado.

Como resultado, se disponen de $n$ vectores $v^{f_k}$ que son finalmente concatenados en uno único, listo para
