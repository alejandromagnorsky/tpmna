...
Del total de las ciudades muestradas, se realiza un filtro para considerar aquellas que cumplan quetal que $ (\mu \pm \frac{\delta}{2}) \in [4,25]$, donde $\mu$ es la velocidad media y las oscilaciones  $ \delta =  \sqrt{ A_1^2 + B_1^2 } $ . Esto significaría seleccionar las ciudades que posean no sólo su valor medio en el rango, sino que la totalidad de sus puntos dentro de dicho intervalo.
