...
Del total de las ciudades muestradas, se realiza un filtro para considerar aquellas que cumplan que $ (\mu \pm \frac{\delta}{2}) \in [4,25]$, donde $\mu$ es la velocidad media y  $ \delta =  \sqrt{ A_1^2 + B_1^2 } $ es la amplitud de la velocidad del viento. Esto significaría seleccionar las ciudades que posean, no sólo su valor medio en el rango, sino que la totalidad de sus puntos dentro de dicho intervalo.
