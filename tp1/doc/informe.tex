...
!!!!!!!! USAR $||Q_{2}^{T}\vec{b}||^{2}$ PARA CALCULAR $\sum_{k=1}^n e_k^2$ \\
!!!!!!!! USAR hist(ek) para cada estacion meteorologica \\
...
\begin{figure}
	...
	\caption{Implementación de la resolución de cuadrados mínimos por medio de la factorización QR usando Householder.}
\end{figure}
