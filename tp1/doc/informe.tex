...
Como la muestra de datos se desarrolló durante un período de 17 años completos, si analizamos la ecuación \ref{equation:model} podemos ver que tanto el segundo término como el tercero se pueden despreciar, ya que

\begin{equation}
\int_0^{(1978-1961)365.25 = 6209.25} sin( \frac{2 \pi t}{365.25} )  = \frac{1-cos(\frac{2 \pi 6209.25}{365.25})}{ \frac{2 \pi }{365.25}} = 0 \\ 
\end{equation}
\begin{equation}
\int_0^{6209.25} cos( \frac{2 \pi t}{365.25} )  = \frac{sin(\frac{2 \pi 6209.25}{365.25})}{ \frac{2 \pi }{365.25}} = 0 \\ 
\end{equation}
